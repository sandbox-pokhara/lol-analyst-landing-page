...
export default function Tos() {
  ...
  return (
    <div className="tos">
      ...
      <p className="paragraph">For the purposes of these Terms and Conditions:</p>
      <ul className="paragraph">
        ...
        <li>
          <p className="paragraph">
            <strong>Website</strong> refers to LolAnalystApp, accessible from{" "}
            <a
              href="https://lolanalyst.app"
      ...
      <h1 className="heading-large">Acknowledgment</h1>
      <p className="paragraph">
      ...
      <p className="paragraph">
        ...
        when You use the Application or the Website and tells You about Your privacy rights and how
        the law protects You. Please read Our Privacy Policy carefully before using Our Service.
      </p>
      ...
      <h1 className="heading-large">Termination</h1>
      <p className="paragraph">
      ...
      <h1 className="heading-large">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
      <p className="paragraph">
